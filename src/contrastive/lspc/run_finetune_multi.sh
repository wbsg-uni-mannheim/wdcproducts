...
AUG=$9
PREAUG=${10}
python run_finetune_multi.py \
	--model_pretrained_checkpoint ../../reports/contrastive/${CATEGORY/multi/}-$SIZE-$PREAUG$BATCH-$LR-$TEMP-${MODEL##*/}/pytorch_model.bin \
    --do_train \
	--frozen=$FROZEN \
    ...
    --output_dir ../../reports/contrastive-ft-multi/$CATEGORY-$SIZE-$AUG$BATCH-$PREAUG$LR-$TEMP-$FROZEN-${MODEL##*/}/ \
